...
class SCServo : public CSerial{
	public:
		...
		int sc_writeWord(u8 ID, u8 MemAddr, u16 wDat);//д2���ֽ�
		int st_writeWord(u8 ID, u8 MemAddr, u16 wDat);//д2���ֽ�
		int EnableTorque(u8 ID, u8 Enable);//Ť������ָ��
		int sc_WritePos(u8 ID, u16 Position, u16 Time, u16 Speed = 0);//��ͨдλ��ָ��
		int st_WritePos(u8 ID, u16 Position, u16 Time, u16 Speed = 0);//��ͨдλ��ָ��
		int sc_RegWritePos(u8 ID, u16 Position, u16 Time, u16 Speed = 0);//�첽дλ��ָ��
		int st_RegWritePos(u8 ID, u16 Position, u16 Time, u16 Speed = 0);//�첽дλ��ָ��
		void RegWriteAction();//ִ���첽дָ��
		void sc_SyncWritePos(u8 ID[], u8 IDN, u16 Position, u16 Time, u16 Speed = 0);//ͬ��дλ��ָ��
		void st_SyncWritePos(u8 ID[], u8 IDN, u16 Position, u16 Time, u16 Speed = 0);//ͬ��дλ��ָ��
		int sc_WriteSpe(u8 ID, s16 Speed);//��Ȧ����ָ��
		int st_WriteSpe(u8 ID, s16 Speed);//��Ȧ����ָ��
		int Read(u8 ID, u8 MemAddr, u8 *nData, u8 nLen);//��ָ��
		int readByte(u8 ID, u8 MemAddr);//��1���ֽ�
		int sc_readWord(u8 ID, u8 MemAddr);//��2���ֽ�
		int st_readWord(u8 ID, u8 MemAddr);//��2���ֽ�
		int sc_ReadPos(u8 ID);//��λ��
		int st_ReadPos(u8 ID);//��λ��
	...
	private:
		...
		int sc_writePos(u8 ID, u16 Position, u16 Time, u16 Speed, u8 Fun);
		int st_writePos(u8 ID, u16 Position, u16 Time, u16 Speed, u8 Fun);
		void Host2SCS(u8 *DataL, u8* DataH, int Data);//1��16λ�����Ϊ2��8λ��
		int	SCS2Host(u8 DataL, u8 DataH);//2��8λ�����Ϊ1��16λ��
		void Host2STS(u8 *DataL, u8* DataH, int Data);//1��16λ�����Ϊ2��8λ��
		int	STS2Host(u8 DataL, u8 DataH);//2��8λ�����Ϊ1��16λ��
		int	Ack(u8 ID);//����Ӧ��
